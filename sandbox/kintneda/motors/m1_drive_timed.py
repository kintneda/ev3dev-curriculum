...
Authors: David Fisher and Damon Kintner.
...
#     800 degrees / second  -->  traveled 37 inches  -->  7.4 inches / second
#     900 degrees / second  -->  traveled 37 inches  -->  7.4 inches / second (probably no faster than 800)
#
...
#
#       speed_in_inches_per_second = speed_in_degrees_per_second/88 + 0
#
...
def main():
    ...
    while time_s != 0:
        speed = int(input("Enter a speed(0 t0 900 dps): "))
        distance = int(input("Distance to travel (inches): "))
        time_s = distance/(speed/88)
